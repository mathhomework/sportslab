"""
Django settings for sportslab project.
...
SECRET_KEY = '@_994#7d0bs7k0awcu=qrjiq!$6o9hnn3%4n8uk1pd%osq-eri'
...
ROOT_URLCONF = 'sportslab.urls'

WSGI_APPLICATION = 'sportslab.wsgi.application'
